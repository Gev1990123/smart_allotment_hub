            ...
            "varieties": [
                {
                    ...
                    "description": r[2],
                    "sow_type":r[3],
                    "moisture_min": float(r[4]),
                    "moisture_max": float(r[5]),
                    "light_min": r[6] if r[6] else None,
                    "light_max": r[7] if r[7] else None,
                    "temp_min": r[8] if r[8] else None,
                    "temp_max": r[9] if r[9] else None,
                    "sensor_count": r[10],
                }
                for r in rows
            ]
